...
const verifyUser = () => {
  if (
    ...
    "Andru" ||
    "Jayde" ||
    ("Cassie" && pword.value === "password")
  ) {
    minfo.innerHTML =
      "Meeting Wednesdays @ 6:30-7:30pm cst. 6:00-6:30 social hour<br>Do your homework!<br>Hunt airstreams<br>Help me get a good photo to use for you!";
  } else {
